'''
    Original codebase for this file was written by: https://github.com/xiaoxu193
    And can be found here: https://github.com/xiaoxu193/PyTeaser

    Slight modifications were made to the Summarize function to suit my needs.  
'''
